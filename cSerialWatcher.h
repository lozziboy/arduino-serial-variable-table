//-------------------------------------------------------------------------------------------------------------------------------------------------------------
// CLASS SERIAL WATCHER - version 1.0.0
...
// 
// > copy SerialWatcher library cSerialWatch.h inside your project folder and include it on top of the main.ino
...
// 
// > upload the software to the shield and then run SerialWatcherApp on your computer to monitor/edit the mapped global variables
//
...
#define SERIALWATCHER_TX_MAX_ACHAR 5       // array of chars: array 0 .. TX_MAX_ACHAR - 1
